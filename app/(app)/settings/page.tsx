          ...
          <div className="flex flex-col gap-5 rounded-2xl border border-slate-200 bg-white p-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-slate-500">
                  Mandatory for transaction amounts exceeding $2,000.
                </p>
              </div>
              <div className="flex items-center gap-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-slate-500">
                  Last changed 45 days ago. We recommend rotations every 90
                  days.
                </p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-col gap-1">
                ...
                <p className="text-xs text-slate-500">
                  3 remaining hardware storage offline keys.
                </p>
              </div>
              <button className="text-xs font-semibold text-blue-500 hover:text-blue-600">
                Regenerate
        ...
        <div className="flex w-full shrink-0 flex-col gap-6 lg:w-[480px]">
          ...
          <div className="flex flex-col gap-5 rounded-2xl border border-slate-200 bg-white p-6">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-[13px] text-slate-500">
                Entities with direct active keys signed into Vault.
              </p>
            </div>
            <Divider />
